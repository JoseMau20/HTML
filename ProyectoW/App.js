...
function actualizarCarrito() {
    ...
    carrito.innerHTML += `
    <ul>
            <li style="justify-content: flex-end; border-bottom: none; font-size: 18px; align-items: center; display: flex; font-weight: bold;">
...
function button_productos(evento)
{
    if(evento) {
        evento.preventDefault();
    }

    let subproductos = document.getElementById('submenu-productos');

    if(subproductos) subproductos.classList.toggle('abierto');
}